      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-xl font-semibold text-cyan-400 mb-4 text-center lg:text-center">
              💻 Technical Skills
            </h3>
          ...
          <div className="w-full lg:w-1/2">
            <h3 className="text-xl font-semibold text-purple-400 mb-4 text-center lg:text-center">
              🤝 Non-Technical Skills
            </h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 place-items-center">
